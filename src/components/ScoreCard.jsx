    ...
    <section className="shadow-[0_0_48px_rgba(31,90,133,0.2)] bg-white rounded-lg">
      <div className="text-center pt-8">
        ...
        <div className="flex justify-center relative">
          <CustomPieChart />
          <div className="absolute w-16 h-16 overflow-hidden bottom-1 z-1">
        ...
        <p className="text-primary-black text-center text-lg mb-4">
          is your <span className="text-[#00A6CA]">NB</span> Score as of 19th Apr '22
        </p>
        
        <div className="flex items-center bg-white justify-between py-4 px-6 h-20  shadow-[0_0_48px_rgba(31,90,133,0.2)] rounded-b-lg">
          <a href="#" className="text-custom-blue-2 text-base font-medium underline">Score Analysis</a>
          <button className="bg-[#FDDC02] w-[238px] h-12 flex items-center justify-center text-black rounded-[40px] text-base font-medium">
            Refresh Now
          </button>
        </div>
      </div>
