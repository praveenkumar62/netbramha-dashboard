...
export default function Topbar(props) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 md:pl-[260px]" role="navigation">
      <div className="border-b border-custom-grey bg-white lg:pr-8 max-w-[1106px] mx-auto">
